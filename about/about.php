...
<div class="about-template">
            ...
            <section class="about-banner">
                <div class="paral" id="parallax">
                    <div class="parallax-content">
                        <div class="paraLogo">
                            <?php if (!empty($about_banner['europe_logo'])) { ?>
                                <img src="<?php echo $about_banner['europe_logo']['url']; ?>"
                                     alt="<?php echo $about_banner['europe_logo']['alt']; ?>">
                            <?php } ?>
                        </div>
                        <?php if ($about_banner['learn_more_button_text'] == '' && $about_banner['agenda_button_text'] == '') { ?>
                            <div class="paraAbout">
                                ...
                                <div class="parabtn">
                                    <a href="<?php echo $about_banner['register_button_link']; ?>"
                                       style="background-color:<?php echo $about_banner['register_color']; ?>"
                                       target="_blank"><?php echo $about_banner['register_button_text']; ?></a>
                                </div>
                            </div>
                        <?php } else { ?>
                            <div class="paraAbout">
                                ...
                                <div class="parabtn" style="width: 100%;">
                                    <a href="<?php echo $about_banner['register_button_link']; ?>"
                                       style="background-color:<?php echo $about_banner['register_color']; ?>"
                                       target="_blank"><?php echo $about_banner['register_button_text']; ?></a>
                                    <a href="<?php echo $about_banner['learn_more_button_link']; ?>"
                                       style="background-color:<?php echo $about_banner['register_color']; ?>"
                                       target="_blank"><?php echo $about_banner['learn_more_button_text']; ?></a>
                                    <a href="<?php echo $about_banner['agenda_button_link']; ?>"
                                       style="background-color:<?php echo $about_banner['register_color']; ?>"
                                       target="_blank"><?php echo $about_banner['agenda_button_text']; ?></a>
                                </div>
                            </div>
                        <?php } ?>
                    </div>
                    <div class="paral_layer parallax" id="paral-0" data-speed="2"
                         style="background-image: url(<?php echo $about_banner['banner_parellax_image_one']; ?>);"></div>
                    <!-- 00.0 -->
                    <div class="paral_layer parallax settor" id="paral-1" data-speed="11"
                         style="background-image: url(<?php echo $about_banner['banner_parellax_image_two']; ?>);"></div>
                    <!-- 12.5 -->
                    <div class="paral_layer parallax settor" id="paral-2" data-speed="26"
                         style="background-image: url(<?php echo $about_banner['banner_parellax_image_three']; ?>);"></div>
                    <!-- 25.0 -->
                    <div class="paral_layer parallax settor" id="paral-3" data-speed="49"
                         style="background-image: url(<?php echo $about_banner['banner_parellax_image_four']; ?>);"></div>
                    <!-- 37.5 -->
                    <div class="paral_layer settor" id="paral-4" data-speed="100"
                         style="background-image: url(<?php echo $about_banner['banner_parellax_image_five']; ?>);"></div>
                    <!-- 50.0 -->
                </div>
            </section>
            <!-- About Banner End -->
    ...
    <?php ob_start();
    $for_advertisement = get_field('add_banner');
    if ($for_advertisement) { ?>
        <?php if (!empty($for_advertisement['add_banner_image'])) { ?>
            <!-- News Image slider start -->
            <?php echo do_shortcode('[aibc-banner-adds banner_image = ' . $for_advertisement["add_banner_image"] . ' banner_link = ' . $for_advertisement["add_banner_link"] . ' ]'); ?>
                ...
                <div class="container">
                    ...
                    <div class="attendees-content">
                        <?php if (!empty($attendees['attendees_image_for_desktop'])) { ?>
                            <img src="<?php echo $attendees['attendees_image_for_desktop']['url']; ?>"
                                 alt="<?php echo $attendees['attendees_image_for_desktop']['alt']; ?>"
                                 class="for-desktop">
                        <?php } ?>
                        <?php if (!empty($attendees['attendees_image_for_mobile'])) { ?>
                            <img src="<?php echo $attendees['attendees_image_for_mobile']['url']; ?>"
                                 alt="<?php echo $attendees['attendees_image_for_mobile']['alt']; ?>"
                                 class="for-mobile">
                        <?php } ?>
                    </div>
                </div>
            ...
            <section class="floor-plan">
                <div class="container">
                    ...
                    <div class="iframe-plan">
                        <iframe style="border: 1px solid rgba(0, 0, 0, 0.1); max-width: 100%; max-height: 576px;"
                                width="800" height="450" src="https://maltaweek2021.expofp.com"
    ...
    <?php ob_start();
    $explore_all = get_field('explore_all');
    if ($explore_all) { ?>
                            ...
                            <div class="single-explore">
                                <?php if (!empty($value['explore_logo'])) { ?>
                                    <div class="explore-img">
                                        <img src="<?php echo $value['explore_logo']['url']; ?>"
                                             alt="<?php echo $value['explore_logo']['alt']; ?>"
                                             style="height:4em; margin-top: 2em; margin-bottom: 2em;"
                                             class="for-mobile">
                                    </div>
                                <?php } ?>
                                <div class="about-section-title">
                                ...
                                <div class="explore-btns">
                                    <?php if (!empty($value['explore_button_one'])) { ?>
                                        <span>
							        	<a href="<?php echo $value['explore_button_one_link']; ?>"
                                           target="_blank"><?php echo $value['explore_button_one']; ?></a>
							        </span>
                                    <?php } ?>
                                    <?php if (!empty($value['explore_button_two'])) { ?>
                                        <span>
							          	<a href="<?php echo $value['explore_button_two_link']; ?>"
                                           target="_blank"><?php echo $value['explore_button_two']; ?></a>
							        </span>
                                    <?php } ?>
                                </div>
                            </div>
    ...
    <?php ob_start();
    $our_attendees = get_field('what_our_attendees');
    if ($our_attendees) { ?>
