<?php
/**
 * Template Name: AIBC Single Post Layout
...
$post = get_post();
$fallback_sidebars_left = '133187, 133190';
$fallback_sidebars_right = '133189, 133184, 133188';
...
$banner_category = get_field('banner_cateogry', get_the_ID());
$firstcategory = (($banner_category != null && $banner_category != '') ? $banner_category : (!empty($terms) ? $terms[0] : null));
if($firstcategory != null){
	$featured_image_category = get_field('single_news_header', $firstcategory);
	...
	$header_link = get_field('single_news_header_link', $firstcategory);
} else {
	...
	<div class="blog-content">
		<div class="page-container">
			...
			<div class="blog-leftbar">
				<?php echo do_shortcode('[aibc_show_sidebar elements="'.$sidebars_left_final.'"]'); ?>
			</div>
			<!-- Leftbar end -->
...
//                    set_post_thumbnail_from_content();
				...
				<div class="releted-post">
					...
					<div class="listing-wrapper">
						<?php 
						//echo do_shortcode('[aibc-related-articles post_per_page = 10]');
			...
			<div class="blog-rightbar">
				<?php echo do_shortcode('[aibc_show_sidebar elements="'.$sidebars_right_final.'"]'); ?>
			</div>
			<!-- Rightbar end -->
		</div>
	</div>
