...
<!--                           style="background-image:url('--><?php //echo get_the_post_thumbnail_url($featured_post->ID, 'full'); ?>/*') ">*/
		...
		<div class="container">
			<div class="home-news">
				...
				<div class="affiliate hp-center">
					<?php
					$news_tags = aibc_get_news_tags_data(1886, 'news-cat', 12);
					?>
					<div class="h-title">
	...
	<?php aibc_get_continent_order($page_id); ?>
	...
	<section class="home-blog">
		<div class="container">
			<div class="home-news">
				...
				<div class="affiliate hp-center">
					<?php
					$news_tags = aibc_get_news_tags_data(1914, 'news-cat', 5);
					?>
					<div class="h-title">
						<a href="<?php echo get_tag_link($news_tags['term_value']->term_id); ?>">
							<?php if(isset($news_tags['term_value']->name)) {
					...
					<div class="blog-listing-module">
						...
						foreach ( $news_tags['term_data'] as $k => $post ) {
							...
							<?php } ?>
						<?php $row++; } ?>
						<?php echo do_shortcode('[aibc-get-testimonials appearance="broker" term_id=4675]'); ?>
					</div>
				</div>
				<div class="spotify hp-right">
					<?php $news_tags = aibc_get_news_tags_data(1942, $taxonomy, 12); ?>
					<div class="h-title">
