	...
	<div class="container">
		<div class="home-news">';
			...
			<div class="affiliate hp-center">';
				$news_tags = aibc_get_news_tags_data(1944, $taxonomy, 9);
				...
				<div class="magazine-section">
					<div class="sigma-magazines testimonial-slide-home">';
						$sigma_magazines = aibc_get_magazines(1149);
			...
			<div class="spotify hp-right">';
				$news_tags = aibc_get_news_tags_data(2057, $taxonomy, 12);
				$europe .= '<div class="h-title">
					<a href="' . get_tag_link($news_tags['term_value']->term_id) . '">' .
						$news_tags['term_value']->name . '<i class="fa fa-angle-right" aria-hidden="true"></i>
					</a>
...
$asia = '<section class="home-blog">
	<div class="container">
		<div class="home-news">';
			...
			$asia .= '</div>
			<div class="affiliate hp-center">';
				$news_tags = aibc_get_news_tags_data(1907, $taxonomy, 6);
				...
				<div class="blog-listing-module">';
					...
					$asia .= do_shortcode('[aibc-get-testimonials appearance="frontpage" term_id=1307]');
				$asia .= '</div>
			</div>
			<div class="spotify hp-right">';
				$news_tags = aibc_get_news_tags_data(1882, $taxonomy, 12);
				$asia .= '<div class="h-title">
					<a href="' . get_tag_link($news_tags['term_value']->term_id) . '">' .
						$news_tags['term_value']->name . '<i class="fa fa-angle-right" aria-hidden="true"></i>
					</a>
...
$americas .= '</div>
			<div class="affiliate hp-center">';
				$news_tags = aibc_get_news_tags_data(1914, $taxonomy, 5);
...
$americas .= do_shortcode('[aibc-get-testimonials appearance="broker" term_id=4675]');

$americas .= '</div>
			</div>
			<div class="spotify hp-right">';
				$news_tags = aibc_get_news_tags_data(1936, $taxonomy, 12);
				$americas .= '<div class="h-title">
					<a href="' . get_tag_link($news_tags['term_value']->term_id) . '">' .
						$news_tags['term_value']->name . '<i class="fa fa-angle-right" aria-hidden="true"></i>
					</a>
...
$africa = '<section class="home-blog">
	<div class="container">
		<div class="home-news">';
			$news_tags = aibc_get_news_tags_data(1889, $taxonomy, 13);
			...
			$africa .= '</div>
			<div class="affiliate hp-center">';
				$news_tags = aibc_get_news_tags_data(1937, $taxonomy, 12);
			...
			<div class="spotify hp-right">';
				$news_tags = aibc_get_news_tags_data(1942, $taxonomy, 12);
				$africa .= '<div class="h-title">
					<a href="' . get_tag_link($news_tags['term_value']->term_id) . '">' .
						$news_tags['term_value']->name . '<i class="fa fa-angle-right" aria-hidden="true"></i>
					</a>
...
if($sort == 'asia'){
	echo $asia . do_shortcode( '[aibc-banner-adds banner_add="sigma_asia_banners" page_id='.$page_id.']' ) . $europe . do_shortcode( '[aibc-banner-adds banner_add="sigma_europe_banners" page_id='.$page_id.']' ) . $americas .  do_shortcode( '[aibc-banner-adds banner_add="sigma_americas_banners" page_id='.$page_id.']' ) . $africa . do_shortcode( '[aibc-banner-adds banner_add="sigma_africa_banners" page_id='.$page_id.']' );
} else if($sort == 'americas'){
	echo $americas . do_shortcode( '[aibc-banner-adds banner_add="sigma_americas_banners" page_id='.$page_id.']' ) . $europe . do_shortcode( '[aibc-banner-adds banner_add="sigma_europe_banners" page_id='.$page_id.']' ) . $asia . do_shortcode( '[aibc-banner-adds banner_add="sigma_asia_banners" page_id='.$page_id.']' ) . $africa . do_shortcode( '[aibc-banner-adds banner_add="sigma_africa_banners" page_id='.$page_id.']' );
} else if($sort == 'africa'){
	echo $africa . do_shortcode( '[aibc-banner-adds banner_add="sigma_africa_banners" page_id='.$page_id.']' ) . $europe . do_shortcode( '[aibc-banner-adds banner_add="sigma_europe_banners" page_id='.$page_id.']' ) . $asia . do_shortcode( '[aibc-banner-adds banner_add="sigma_asia_banners" page_id='.$page_id.']' ) . $americas . do_shortcode( '[aibc-banner-adds banner_add="sigma_americas_banners" page_id='.$page_id.']' );
} else{
	echo $europe . do_shortcode( '[aibc-banner-adds banner_add="sigma_europe_banners" page_id='.$page_id.']' ) . $asia . do_shortcode( '[aibc-banner-adds banner_add="sigma_asia_banners" page_id='.$page_id.']' ) . $americas . do_shortcode( '[aibc-banner-adds banner_add="sigma_americas_banners" page_id='.$page_id.']' ) . $africa . do_shortcode( '[aibc-banner-adds banner_add="sigma_africa_banners" page_id='.$page_id.']' );
}
?>