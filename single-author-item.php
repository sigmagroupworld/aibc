 ...
 *
 * Template Name: AIBC Author Layout
	...
	<div class="blog-content">
		<div class="page-container">
			...
			<div class="blog-leftbar">
				<?php echo do_shortcode('[aibc_show_sidebar elements="22554"]'); ?>
			</div>
			<!-- Leftbar end -->
			...
			<div class="blog-details">
				<div class="blog-inner-details"><div class="blog-author-info">
				  ...
				  <div>
					<?php echo do_shortcode('[aibc-related-articles author_id='.$post_id.']') ?>
				  </div>
				</div>
			</div>
			...
			<div class="blog-rightbar">
				<?php echo do_shortcode('[aibc_show_sidebar elements="22586, 22579, 22549, 22583"]'); ?>
			</div>
			<!-- Rightbar end -->
		</div>
	</div>
